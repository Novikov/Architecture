  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `movie_table` (`id` INTEGER PRIMARY KEY AUTOINCREMENT, `voteCount` INTEGER, `video` INTEGER, `vote_count` REAL, `title` TEXT, `popularity` REAL, `posterPath` TEXT, `originalLanguage` TEXT, `originalTitle` TEXT, `genreIds` TEXT, `backdropPath` TEXT, `adult` INTEGER, `overview` TEXT, `release_date` TEXT)");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \"4850626a3e8ee9dd7304a5095e5d85b6\")");
      }
      ...
      protected void validateMigration(SupportSQLiteDatabase _db) {
        ...
        _columnsMovieTable.put("vote_count", new TableInfo.Column("vote_count", "REAL", false, 0));
        ...
        _columnsMovieTable.put("release_date", new TableInfo.Column("release_date", "TEXT", false, 0));
    ...
    }, "4850626a3e8ee9dd7304a5095e5d85b6", "688ec23f17102477b564c8a95d16e3fd");
