...
public class ActivityAddBindingImpl extends ActivityAddBinding implements com.raywenderlich.wewatch.generated.callback.OnClickListener.Listener {
    ...
    private androidx.databinding.InverseBindingListener titleEditTextandroidTextAttrChanged = new androidx.databinding.InverseBindingListener() {
        @Override
        public void onChange() {
            // Inverse of viewModel.title.get()
            //         is viewModel.title.set((java.lang.String) callbackArg_0)
            java.lang.String callbackArg_0 = androidx.databinding.adapters.TextViewBindingAdapter.getTextString(titleEditText);
    ...
    private androidx.databinding.InverseBindingListener yearEditTextandroidTextAttrChanged = new androidx.databinding.InverseBindingListener() {
        @Override
        public void onChange() {
            // Inverse of viewModel.releaseDate.get()
            //         is viewModel.releaseDate.set((java.lang.String) callbackArg_0)
            java.lang.String callbackArg_0 = androidx.databinding.adapters.TextViewBindingAdapter.getTextString(yearEditText);
            // localize variables for thread safety
            // viewModel.releaseDate != null
            boolean viewModelReleaseDateJavaLangObjectNull = false;
            // viewModel.releaseDate.get()
            ...
            if (viewModelJavaLangObjectNull) {
                ...
                viewModelReleaseDateJavaLangObjectNull = (viewModelReleaseDate) != (null);
                if (viewModelReleaseDateJavaLangObjectNull) {




                    viewModelReleaseDate.set(((java.lang.String) (callbackArg_0)));
                }
            }
        }
    };
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x8L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setTextWatcher(this.titleEditText, (androidx.databinding.adapters.TextViewBindingAdapter.BeforeTextChanged)null, (androidx.databinding.adapters.TextViewBindingAdapter.OnTextChanged)null, (androidx.databinding.adapters.TextViewBindingAdapter.AfterTextChanged)null, titleEditTextandroidTextAttrChanged);
            androidx.databinding.adapters.TextViewBindingAdapter.setTextWatcher(this.yearEditText, (androidx.databinding.adapters.TextViewBindingAdapter.BeforeTextChanged)null, (androidx.databinding.adapters.TextViewBindingAdapter.OnTextChanged)null, (androidx.databinding.adapters.TextViewBindingAdapter.AfterTextChanged)null, yearEditTextandroidTextAttrChanged);
        }
        if ((dirtyFlags & 0xdL) != 0) {
            // api target 1
